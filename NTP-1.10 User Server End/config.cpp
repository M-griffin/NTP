...
void createconfig()
{
    ...
    outStream2 << "" << endl;
    outStream2 << "# .----------------------------------------------------------------." << endl;
    outStream2 << "# | NTP-USER v1.10b Configuration File                     (WIN32) |-------------" << endl;
    outStream2 << "# `----------------------------------------------------------------'" << endl;
#else
    outStream2 << "" << endl;
    outStream2 << "# .----------------------------------------------------------------." << endl;
    outStream2 << "# | NTP-USER v1.10b Configuration File                     (LINUX) |-------------" << endl;
    outStream2 << "# `----------------------------------------------------------------'" << endl;
#endif
    outStream2 << "#" << endl;
    outStream2 << "#" << endl;
...
#ifdef _WIN32
    outStream2 << "# .----------------------------------------------------------------." << endl;
    outStream2 << "# | Set Download Path ie. C:\\DOWNLOADS\\                            |" << endl;
    outStream2 << "# `----------------------------------------------------------------'" << endl;
#else
    outStream2 << "# .----------------------------------------------------------------." << endl;
    outStream2 << "# | Set Download Path ie. /home/user/downloads/                    |" << endl;
    outStream2 << "# `----------------------------------------------------------------'" << endl;
#endif
    outStream2 << "#" << endl;
    outStream2 << "Set DLPATH \"NONE\"" << endl;
    outStream2 << endl;
    outStream2.close();
    return;
}
