...
void percenttop(long double percentage) {
	...
	color(11);
	bgcolor(3);
	point.X = 41; point.Y = 10;
	SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), point);

	char per1[21]={0};
	char per2[21]={0};

	per2[0] = 176; 	per2[1] = 177; 	per2[2] = 178;	per2[3] = 176;	per2[4] = 177;
	per2[5] = 178;  per2[6] = 176;	per2[7] = 177;	per2[8] = 178;	per2[9] = 176;
	per2[10] = 177;	per2[11] = 178;	per2[12] = 176;	per2[13] = 177;	per2[14] = 178;
	per2[15] = 176;	per2[16] = 177;	per2[17] = 178;	per2[18] = 176; per2[19] = 177;
